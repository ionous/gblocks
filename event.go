...
type BlockCreate struct {
	*Event
	...
	// ids	*js.Object 	An array containing the UUIDs of the new block and any connected child blocks.
}
...
func (evt *BlockMove) NewInputName() (ret string) {
...
func (evt *BlockMove) OldInputName() (ret string) {
