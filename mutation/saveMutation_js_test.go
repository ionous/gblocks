...
// 	testShuape(t, func(ws *Workspace, reg *Registry) {
// 		b, e := ws.NewBlock((*MutableBlock)(nil))
...
// 				expected := []string{"INPUT", "MUTANT", "MUTANT/1/ATOM_INPUT", "FIELD"}
// 				require.Equal(t, expected, reduceInputs(b))
// 			}
// 			t.Log("second")
// 			{
...
// 				expected := []string{"INPUT", "MUTANT", "MUTANT/1/ATOM_INPUT", "MUTANT/2/ATOM_FIELD", "FIELD"}
// 				require.Equal(t, expected, reduceInputs(b))
// 			}
// 			t.Log("third")
// 			{
...
// 				expected := []string{"INPUT", "MUTANT", "MUTANT/1/ATOM_INPUT", "MUTANT/2/ATOM_FIELD", "MUTANT/3/ATOM_INPUT", "FIELD"}
// 				require.Equal(t, expected, reduceInputs(b))
// 			}
// 		}
// 	})
